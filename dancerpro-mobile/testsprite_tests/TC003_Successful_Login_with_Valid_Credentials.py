...
async def run_test():
    ...
    try:
        ...
        # Input correct password and submit login form
        frame = context.pages[-1]
        ...
        assert False, 'Test plan execution failed: JWT token issuance and dashboard redirection could not be verified.'
